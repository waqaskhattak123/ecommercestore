        ...
        <div>
          ...
          >
            ...
            <input
              ...
              autoComplete='true'
            />
            <button className="bg-red-500 w-[300px] font-bold h-[40px]">Create Account</button>
            ...
            <h1 className="bg-white w-[300px] mt-3 border-2 h-[40px] lg:pt-[5px] text-center">Already have an Account! <Link to={'/login'}> LogIn</Link></h1>
          </form>
        </div>
        {/* 2nd div */}
      </div>
