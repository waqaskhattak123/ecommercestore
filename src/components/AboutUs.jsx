...
const AboutUs = () => {
  return (
    <div>
      ...
      {/* Main div */}
      <div>
        <div className="flex flex-col md:grid md:grid-cols-2 md:w-auto mx-[70px] md:mx-[140px] mt-11">
          {/* our story */}
          <div>
            <h1 className="text-5xl">Our Story</h1>
            <p className="w-auto mt-3 font-semibold text-justify">
          ...
          {/* side pic */}
          <div>
            <img src={storyimg} className="mx-[50px]" />
          </div>
          {/* side pic ended */}
        </div>
